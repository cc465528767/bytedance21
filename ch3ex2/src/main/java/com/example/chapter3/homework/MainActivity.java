...
public class MainActivity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        //先设置显示AnimatorSet animatorSet = new AnimatorSet();//组合动画 
        ObjectAnimator animator= ObjectAnimator.ofFloat(target, "scaleX", 1,0,2);
        animator.setDuration(2000);
        animator.setRepeatCount(ObjectAnimator.INFINITE);
        //animator.setRepeatMode(ObjectAnimator.REVERSE);
        //animator.start();
        // TODO 2：在这里实现另一个 ObjectAnimator，对 target 控件的透明度进行修改，从 1 到 0.5f 循环
        ObjectAnimator animator2 = ObjectAnimator.ofFloat(target,"alpha",1,0,0.5f);
...
//        animator2.setRepeatMode(ObjectAnimator.REVERSE);
        ...
        animatorSet.playTogether(animator,animator2,animator1);
        animatorSet.start();
    }
}
